# StarboundMC 跨行星探索玩法开发路线（未确认）

> **状态：仅为未确认的玩法构想，不作为开发指导方案。**
>
> 记录日期：2026-09-17。本文的任务顺序、环境规则、奖励、装备和版本目标都没有获得确认；如需
> 落地，必须另行讨论并建立活动实施计划。
>
> 当前代码背景：宇宙数据驱动基础迁移已落地。当前内置宇宙包含两个恒星系、六个天体，其中五个有
> 可登陆表面，气态巨行星仅支持轨道停靠。下文仍是提案，不是现状说明。
...
另有一个仅可轨道停靠的 Gas Giant。

目标：

> 五个可登陆表面看起来、玩起来、奖励上都明显不同。
...
**文档状态再次确认：以上内容是讨论稿。除非后续单独确认并形成活动计划，不得据此新增方块、
维度、环境伤害、任务、奖励或航行门禁。**
