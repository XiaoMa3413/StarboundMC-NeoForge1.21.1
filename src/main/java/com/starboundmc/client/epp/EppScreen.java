...
public final class EppScreen extends StarboundModularScreen<EppMenu, EquipmentRoot> {
    ...
    @Override protected EquipmentRoot createRoot() { return new EquipmentRoot(leftPos, topPos, title, null); }
