...
public record EppVisualPacket(int entityId, int generation) implements CustomPacketPayload {
    ...
    private EppVisualPacket(FriendlyByteBuf b) { this(b.readVarInt(), b.readVarInt()); }
    private void write(FriendlyByteBuf b) { b.writeVarInt(entityId); b.writeVarInt(generation); }
